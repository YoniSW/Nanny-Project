...
namespace BL
{
    partial class bl_imp : IBL
    {
        ...
        //        Mother m = dal.getMom().Find(x => x.ID == dal.getChild().Find(y => y.ID == _childIDArray[i]).idMother);
        //        try
        //        {
        //            int Nannyid = FindNanny(m);
        //            con = new Contract
        //            {
        //                _childID = _childIDArray[i],
        //                idNanny = Nannyid,
        ...
        //        catch (Exception)
        //        {
        //            //Console.WriteLine(dal.getMother().Find(x => x.ID == dal.getChild().Find(y => y.ID == _childIDArray[i]).idMother).name);
        //            /* don't something*/
        //        }
        //    }
